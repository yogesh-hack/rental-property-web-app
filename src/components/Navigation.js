...
const Navigation = (props) => {
    ...
    return (
        <>
            <nav className='mx-auto px-4 bg-[#0a8051] fixed w-full z-20 top-0 start-0 flex items-center text-white justify-between py-2'>
            <Link className="flex flex-shrink-0 items-center" href="/">
            <img src="https://real-estate-hub-pi.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-white.4b24f69b.png&w=128&q=75" className="h-10 w-auto" alt="logo" />
              ...
              Rental Property Hub
                ...
                <ul className='flex items-center'>
                    <li className='ml-6 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 shadow-lg shadow-white-500/50 '><Link to='/'>Home</Link></li>
                    <li className='ml-6 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 mr-6'><Link to='/products'>Properties</Link></li>
                    <li className='ml-6 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gradient-to-br  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 mr-6'><Link to='/addproperty'>Sell You Property</Link></li>
                    {!(props.name) && (
                        < li className='ml-6 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2'><Link to='/login'>Login</Link></li>
                    )}
                    {(props.name) && (
